...
async function boot(){
  ...
  html=html.replace('</head>','<link rel="stylesheet" href="styles/app.css?v=20260828-1"><style>.timeline{margin-right:0!important;width:100%!important}@media(max-width:430px){.timeline{margin-right:0!important}}</style></head>');
  html=html.replace('</body>','<script type="module" src="js/app-ui.js?v=20260828-3"><\/script></body>');
  document.open();
  document.write(html);
  document.close();
}
