async function boot(){
  ...
  html=html.replace('</head>',`<link rel="stylesheet" href="styles/app.css?v=${build}"><link rel="stylesheet" href="styles/clarity.css?v=${build}"><link rel="stylesheet" href="styles/action-layout.css?v=${build}"></head>`);
